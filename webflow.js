        ...
        window.tram = function(e) {
            ...
            function R(t, n, i) {
                ...
                t === void 0)
                    return i;
                var r = i;
                return we.test(t) || !Xt.test(t) ? r = parseInt(t, 10) : Xt.test(t) && (r = 1e3 * parseFloat(t)),
                0 > r && (r = 0),
                r === r ? r : i
            }
            function B(t) {
            ...
            var P = function(t, n, i) {
                ...
                function m(x, K) {
                    function c() {
                        var j = new T;
                        return s(j.init) && j.init.apply(j, arguments),
                        j
                    }
                    function T() {}
                    K === i && (K = x,
                    x = Object),
                    c.Bare = T;
                    var F, Z = o[t] = x[t], ft = T[t] = c[t] = new o;
                    return ft.constructor = c,
                    c.mixin = function(j) {
                        return T[t] = c[t] = m(c, j)[t],
                        c
                    }
                    ,
                    c.open = function(j) {
                        if (F = {},
                        s(j) ? F = j.call(c, ft, Z, c, x) : r(j) && (F = j),
                        r(F))
                            for (var Tt in F)
                                n.call(F, Tt) && (ft[Tt] = F[Tt]);
                        return s(ft.init) || (ft.init = x),
                        c
                    }
                    ,
                    c.open(K)
              ...
              , $ = {
                ...
                "ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function(t, n, i, r, s) {
                    return s === void 0 && (s = 1.70158),
                    (t /= r / 2) < 1 ? i / 2 * t * t * (((s *= 1.525) + 1) * t - s) + n : i / 2 * ((t -= 2) * t * (((s *= 1.525) + 1) * t + s) + 2) + n
                }
                ]
            }
              , W = {
            ...
            var V = y.frame = function() {
              ...
              , pt = P(function(t) {
                function n(w, O) {
                    ...
                    if (!O.weak || !this.props[N]) {
                        var st = tt[0]
                          , nt = this.props[N];
                        return nt || (nt = this.props[N] = new st.Bare),
                        nt.init(this.$el, Y, tt, O),
                        nt
                    }
                }
                function i(w, O, Y) {
                    if (w) {
                        var N = typeof w;
                        if (O || (this.timer && this.timer.destroy(),
                        this.queue = [],
                        this.active = !1),
                        N == "number" && O)
                ...
                function m(w) {
                    ...
                    var O;
                    typeof w == "string" ? (O = {},
                    O[w] = 1) : O = typeof w == "object" && w != null ? w : this.props,
                    ft.call(this, O, j),
                    Z.call(this)
                }
                function x(w) {
                    m.call(this, w),
                    ft.call(this, w, Tt, ge)
                }
                function K(w) {
                ...
                function Z() {
                    ...
                    this.el.style[h.transition.dom] = Y)
                }
                function ft(w, O, Y) {
                    var N, tt, st, nt, Ft = O !== j, Q = {};
                    for (N in w)
                        st = w[N],
                        N in mt ? (Q.transform || (Q.transform = {}),
                        Q.transform[N] = st) : (b.test(N) && (N = l(N)),
                        N in Ot ? Q[N] = st : (nt || (nt = {}),
                        nt[N] = st));
                    for (N in Q) {
                        if (st = Q[N],
                        tt = this.props[N],
                ...
                function ot(w, O) {
                    t[w] = function() {
                        return this.children ? ye.call(this, O, arguments) : (this.el && O.apply(this, arguments),
                        this)
                    }
                }
                function ye(w, O) {
              ...
              , S = P(function(t) {
                ...
                t.init = function(o, m, x, K) {
                    ...
                    this.name = c,
                    this.type = x[1],
                    this.duration = R(m[1], this.duration, s.duration),
                    this.ease = i(m[2], this.ease, s.ease),
                    this.delay = R(m[3], this.delay, s.delay),
                    ...
                    et.fallback || K.fallback ? this.animate = this.fallback : (this.animate = this.transition,
                    this.string = this.name + vt + this.duration + "ms" + (this.ease != "ease" ? vt + $[this.ease][0] : "") + (this.delay ? vt + this.delay + "ms" : ""))
                }
                ,
                t.set = function(o) {
                ...
                t.fallback = function(o) {
                    ...
                    o = this.convert(o, this.type),
                    this.auto && (m == "auto" && (m = this.convert(this.get(), this.type)),
                    o == "auto" && (o = n.call(this))),
                    this.tween = new St({
                        from: m,
                        to: o,
                ...
                t.convert = function(o, m) {
                    if (o == "auto" && this.auto)
                        return o;
                    var x, K = typeof o == "number", c = typeof o == "string";
                    switch (m) {
                    case f:
                        if (K)
                            return o;
              ...
              , At = P(S, function(t, n) {
                ...
                t.init = function() {
                    ...
                    mt.perspective && et.perspective && (this.current.perspective = et.perspective,
                ...
                t.transition = function(r) {
                    ...
                    for (o in this.current)
                        m[o] = o in s ? s[o] : this.current[o];
                    this.active = !0,
                    this.nextStyle = this.style(m)
                }
                ,
                ...
                t.values = function(r) {
                    ...
                    return i.call(this, r, function(m, x, K) {
                        o[m] = x,
                        this.current[m] === void 0 && (s = 0,
                        ~m.indexOf("scale") && (s = 1),
                        this.current[m] = this.convert(s, K))
                    }),
                    o
                }
            })
              , St = P(function(t) {
                ...
                t.init = function(c) {
                    ...
                    Z === void 0 && (Z = m.to),
                    this.unit = c.unit || "",
                    typeof F == "number" && typeof Z == "number" ? (this.begin = F,
                    this.change = Z - F) : this.format(Z, F),
                ...
                ,
                t.play = function() {
                    this.active || (this.start || (this.start = ct()),
                    this.active = !0,
                    n(this))
                }
                ,
                ...
                t.render = function(c) {
                    ...
                    if (F < this.duration) {
                        ...
                        return T = this.startRGB ? o(this.startRGB, this.endRGB, Z) : s(this.begin + Z * this.change),
              ...
              , Nt = P(St, function(t, n) {
                ...
                ,
                t.render = function(i) {
                    var r, s, o = this.tweens.length, m = !1;
                    for (r = o; r--; )
                        s = this.tweens[r],
                        s.context && (s.render(i),
            ...
            h.transform && h.backface && (mt.z = [M, "translateZ"],
            mt.rotateZ = [G],
            mt.scaleZ = [f],
            mt.perspective = [p]);
            var we = /ms/
        ...
        Kt.exports = function() {
            ...
            e.debounce = function(a, u, v) {
                var h, q, k, V, ct, pt = function() {
                    var J = e.now() - V;
                    J < u ? h = setTimeout(pt, u - J) : (h = null,
                    v || (ct = a.apply(k, q),
                    k = q = null))
                };
                return function() {
            ...
            return e.template = function(a, u, v) {
                ...
                a.replace(h, function(J, S, rt, Lt, At) {
                    return k += a.slice(q, At).replace(kt, vt),
                    q = At + J.length,
                    S ? k += `'+
...
` + k + "}",
    ...
    var gt = lt((Ie,te)=>{
        ...
        ;
        function Gt(e) {
            D.env() && (ht(e.design) && ut.on("__wf_design", e.design),
            ht(e.preview) && ut.on("__wf_preview", e.preview)),
    ...
    var ie = lt((Re,ne)=>{
        ...
        ee.define("brand", ne.exports = function(e) {
            var y = {}, l = document, A = e("html"), C = e("body"), g = ".w-webflow-badge", L = window.location, _ = /PhantomJS/i.test(navigator.userAgent), R = "fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange", B;
            y.ready = function() {
                var W = A.attr("data-wf-status")
                  , H = A.attr("data-wf-domain") || "";
                /\.webflow\.io$/i.test(H) && L.hostname !== H && (W = !0),
                W && !_ && (B = B || P(),
                $(),
                setTimeout($, 500),
                e(l).off(R, U).on(R, U))
    ...
    var oe = lt(($e,re)=>{
        ...
        Bt.define("edit", re.exports = function(e, y, l) {
            if (l = l || {},
            (Bt.env("test") || Bt.env("frame")) && !l.fixture && !Fe())
                return {
                    exit: 1
                };
            var A = {}, C = e(window), g = e(document.documentElement), L = document.location, _ = "hashchange", R, B = l.load || $, U = !1;
            try {
            ...
            function W(E) {
                return function(p) {
                    ...
                    p.thirdPartyCookiesSupported = E,
                    H(I(p.bugReporterScriptPath), function() {
            ...
            function b(E) {
                ...
                var M = function(G) {
                    G.data === "WF_third_party_cookies_unsupported" ? (f(p, M),
                    E(!1)) : G.data === "WF_third_party_cookies_supported" && (f(p, M),
                    E(!0))
                };
                p.onerror = function() {
                    f(p, M),
    ...
    var ae = lt((Be,se)=>{
        ...
        ze.define("focus-visible", se.exports = function() {
            function e(l) {
                ...
                function P(f) {
                    f.metaKey || f.altKey || f.ctrlKey || (_(l.activeElement) && B(l.activeElement),
                    A = !0)
                }
                function $() {
                    A = !1
                ...
                function H(f) {
                    _(f.target) && f.target.hasAttribute("data-wf-focus-visible") && (C = !0,
                ...
                function X() {
                    document.visibilityState === "hidden" && (C && (A = !0),
                    I())
                }
                function I() {
                ...
                function b(f) {
                    f.target.nodeName && f.target.nodeName.toLowerCase() === "html" || (A = !1,
                    z())
                }
    ...
    var fe = lt((Ne,ce)=>{
        ...
        ue.define("focus", ce.exports = function() {
            ...
            function g() {
                typeof document < "u" && document.body.hasAttribute("data-wf-focus-within") && ue.env.safari && (document.addEventListener("mousedown", C, !0),
    ...
    var he = lt((De,le)=>{
        ...
        _t.define("links", le.exports = function(e, y) {
            var l = {}, A = e(window), C, g = _t.env(), L = window.location, _ = document.createElement("a"), R = "w--current", B = /index\.(html|php)$/, U = /\/$/, P, $;
            l.ready = l.design = l.preview = W;
            function W() {
                C = g && _t.env("design"),
                $ = _t.env("slug") || L.pathname || "",
                _t.scroll.off(X),
                P = [];
                for (var z = document.links, b = 0; b < z.length; ++b)
                    H(z[b]);
                P.length && (_t.scroll.on(X),
                X())
            }
            function H(z) {
    ...
    var me = lt((Xe,pe)=>{
        ...
        Me.define("touch", pe.exports = function(e) {
            ...
            y.init = function(g) {
                return g = typeof g == "string" ? e(g).get(0) : g,
                g ? new A(g) : null
            }
            ;
            function A(g) {
                var L = !1, _ = !1, R = Math.min(Math.round(window.innerWidth * .04), 40), B, U;
                g.addEventListener("touchstart", P, !1),
                g.addEventListener("touchmove", $, !1),
                g.addEventListener("touchend", W, !1),
                g.addEventListener("touchcancel", H, !1),
                g.addEventListener("mousedown", P, !1),
                g.addEventListener("mousemove", $, !1),
                g.addEventListener("mouseup", W, !1),
                g.addEventListener("mouseout", H, !1);
                function P(I) {
                    var z = I.touches;
                    z && z.length > 1 || (L = !0,
                    z ? (_ = !0,
                    B = z[0].clientX) : B = I.clientX,
                    U = B)
                }
                function $(I) {
                    if (L) {
                        ...
                        var z = I.touches
                          ...
                          , f = b - U;
                        U = b,
                        Math.abs(f) > R && l && String(l()) === "" && (C("swipe", I, {
                ...
                function X() {
                    ...
                    g.removeEventListener("touchmove", $, !1),
                    g.removeEventListener("touchend", W, !1),
                    g.removeEventListener("touchcancel", H, !1),
                    g.removeEventListener("mousedown", P, !1),
                    g.removeEventListener("mousemove", $, !1),
                    g.removeEventListener("mouseup", W, !1),
                    g.removeEventListener("mouseout", H, !1),
                    g = null
                }
                this.destroy = X
            }
            ...
            return y.instance = y.init(document),
            y
        }
        )
    }
